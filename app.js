...
const _dataSource = (window.siteData) ? {
  ...
  title:    "Love Letter",
  sender:   "Nguyễn Hoàng Phúc Huy",
  receiver: "Trương Hà Mỹ Uyên",
  text:     "Năm nay đã là giao thừa thứ 2 chúng ta đồng hành cùng nhau rồi, anh biết là anh vẫn chưa phải là người đàn ông tốt nhất thế giới này, nhưng anh sẽ luôn luôn cố gắng để trở thành người đàn ông tuyệt vời nhất trong lòng em.\n\nMỗi ngày bên em là một câu chuyện mới, một nụ cười mới và một niềm tin mới vào tương lai. Anh thương em đến từng điều nhỏ nhất, từ những lần em kể anh nghe chuyện vui, đến khi em buồn anh được ở bên và san sẻ.\n\nDù sau này có gặp khó khăn, anh vẫn mong chúng ta cùng nhau bước qua, cùng nhau giữ lại những kỷ niệm ấm áp và cùng nhau xây đắp gia đình chúng ta một cách chậm rãi nhưng vững chắc.\n\nMong 2 ta sẽ luôn chúc nhau thế này mỗi năm em nhé",
  song:     "./song.mp3",
  images: [
    "./images/bgcqjh0a.55j.jpeg",
    "./images/5fhz0ver.gry.jpeg",
    "./images/lzbnesb1.2ca.jpeg",
    "./images/jyg2rqun.1fx.jpeg",
    "./images/mzbnhhoq.tgu.jpeg",
    "./images/mn41lj4p.eq0.jpeg",
    "./images/dderhkan.v4d.jpeg",
    "./images/and5bcb2.i0s.jpeg",
    "./images/qvz5gq44.um2.jpeg",
  ],
};
...
// ── Render letter content (exact OurMemories logic) ──────────────────────────
function renderLetter() {
  ...
  if (bodyTopEl && bodyBotEl) {
    ...
    paragraphs.forEach(text => {
      ...
      const paragraphNode = appendParagraph(bodyTopEl, text);
      if (bodyTopEl.scrollHeight > bodyTopEl.clientHeight) {
        bodyTopEl.removeChild(paragraphNode);
    ...
    paragraphs.forEach(text => appendParagraph(bodyTopEl, text));
  }
}
...
function renderImages() {
  ...
  polaroids.forEach((img, i) => { if (imageSources[i + 1]) img.src = imageSources[i + 1]; });
}
